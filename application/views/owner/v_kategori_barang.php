        ...
        <div class="modal" tabindex="-1" role="dialog" id="diskon">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Owner/Barang/kategori_barang_tambah" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                                 <div class="col-md-12">
                                    <label class="control-label mt-10">Nama Kategori</label>
          ...
          <div class="modal" tabindex="-1" role="dialog" id="editdata<?php echo $diskon_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Owner/Barang/kategori_barang_update" method="post" enctype="multipart/form-data">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="hapusdata<?php echo $diskon_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-20">
                        <form action="<?php echo base_url()?>Owner/Barang/kategori_barang_hapus" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="diskon_id" value="<?php echo $diskon_id?>">
