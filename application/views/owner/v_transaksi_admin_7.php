      ...
      <?php if($level1 == 0) :?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Owner/Transaksi/cari_trx_admin_7/0" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Owner/Transaksi/cari_trx_admin_7/1" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                               <div class="col-md-6">
                                      <label class="control-label">Dari Tanggal*</label>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Owner/Transaksi/cari_trx_admin_7/2" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                               <div class="col-md-6">
                                      <label class="control-label">Dari Tanggal*</label>
      ...
      <?php if($level1 == 0) :?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url()?>Owner/Transaksi/cetak_trx_admin_7/0" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url()?>Owner/Transaksi/cetak_trx_admin_7/1" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url()?>Owner/Transaksi/cetak_trx_admin_7/2" method="post" enctype="multipart/form-data">
