        ...
        <div class="modal" tabindex="-1" role="dialog" id="diskon">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Subowner/Diskon/save_diskon" method="post" enctype="multipart/form-data">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="tanggal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Subowner/Diskon/hapus_diskon_t" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                                <div class="col-md-12">
          ...
          <div class="modal" tabindex="-1" role="dialog" id="editdata<?php echo $diskon_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url()?>Subowner/Diskon/update_diskon" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-20">
                            <div class="row">
                                <div class="col-md-12">
        ...
        <div class="modal" tabindex="-1" role="dialog" id="hapusdata<?php echo $diskon_id?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-20">
                        <form action="<?php echo base_url()?>Subowner/Diskon/hapus_diskon" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="diskon_id" value="<?php echo $diskon_id?>">
                                    <input type="hidden" name="barang_id" value="<?php echo $barang_id?>"> 
