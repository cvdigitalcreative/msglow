<?php
	...
	class M_request_stock extends CI_Model
	{
		...
		function tambah_request_stock($nama_barang,$jumlah,$id_toko_dari,$id_toko_ke,$id,$tanggal_acc,$status){
			...
			$hasil= $this->db->query("INSERT INTO request_stok_barang(nama_barang,id_toko_dari,nama_toko_dari,id_toko_ke,nama_toko_ke,id_admin,tanggal_acc,status,jumlah) VALUES ('$nama_barang','$id_toko_dari','$nama_toko_dari','$id_toko_ke','$nama_toko_ke','$id_admin','$tanggal_acc','$status','$jumlah')");
		...
		function acc_request_stock($nama_barang,$jumlah,$id_toko_dari,$id_toko_ke,$id,$tanggal_acc,$status,$id_request){
			...
			$this->db->query("UPDATE request_stok_barang SET status ='1' WHERE id_request = '$id_request'");
